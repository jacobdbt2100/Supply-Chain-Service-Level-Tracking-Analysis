...
1. Over the past six months, the company consistently failed to meet Service Level Agreement (SLA) targets, recording an average **delivery delay of +0.5 days per order** and an average **order-line shortfall of approximately 8 units per order line,** indicating persistent lead-time variability and significant gaps in inventory availability and order fill rate.
